...
Note that `inner_join` drops rows that aren't contained in both tables. Only about a third of the books in the `shortTitles` folder have an lc1 that matches the classifications field.
